      ...
      <div className="relative flex items-center justify-center gap-2">
        {loading ? (
          <>
            ...
            <span className="transition-opacity duration-200">{state ? "Unfollowing..." : "Following..."}</span>
          </>
        ) : (
          <>
            <div className="relative">
              {state ? (
                <Heart
                  className={cn("h-4 w-4 transition-all duration-300", "fill-current transform group-hover:scale-110")}
                />
              ) : (
                <UserPlus
                  className={cn(
